...
const emptyPlan={salableProductId:"",salableProductName:"",name:"",frequency:"monthly" as SubscriptionFrequency,deliveriesPerTerm:4,price:0,active:true,description:""};
